// <copyright file="PasteFromJsonSchema.cs" company="T-Rnd">
...
namespace JsonToCSharp
{
    ...
    internal sealed class PasteFromJsonSchema
    {
        ...
        {
            return _dte ?? (_dte = await package.GetServiceAsync(typeof(SDTE)) as DTE2);
        }
        ...
        private async void SchemaMenuItemCallback(object sender, EventArgs e)
        {
            await ThreadHelper.JoinableTaskFactory.SwitchToMainThreadAsync();
            ...
            {
                MessageBox.Show(
                    "Copied text is not a JSON Schema!\r\n" + ex.Message,
                    "JSON Schema Error",
                    MessageBoxButton.OK,
                    MessageBoxImage.Error);
            }
